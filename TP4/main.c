...
// Fonction qui cree une pile d'une capacite donn�e en entr�e
...
{ 
    return (stack->top == stack->capacite - 1); //si top=capacite=>true si non false
} 
 
// Pile est vide quand le top est egal � -1 
int isEmpty(struct Stack* stack) 
{ 
    return (stack->top == -1); //si -1=>empty si non pleine
} 
...
/////////////////////RECURSIVE////////////////////////////////////////////
/*
n : nombre de disques utilise
D : emplacement de depart
A : emplacement d'arrivee
